...
$MESS["USHAKOV_COOKIE_OPT_TEXT"] = "Мы используем файлы cookie для обеспечения работы сайта, сбора анонимной статистики и улучшения пользовательского опыта. Продолжая использование сайта, вы соглашаетесь на обработку ваших данных с использованием cookie-файлов в соответствии с нашей <a href=\"/cookies-agreement.php\" target=\"_blank\">политикой конфиденциальности</a>.";
// $MESS["USHAKOV_COOKIE_OPT_LINK"] = "<b>Ссылка на страницу</b> с условиями";
// $MESS["USHAKOV_COOKIE_OPT_LINK_COLOR"] = "Цвет ссылки";
// $MESS['USHAKOV_COOKIE_OPT_TEXT_COLOR'] = "Цвет текста";
$MESS['USHAKOV_COOKIE_OPT_BG_COLOR'] = "Цвет фона плашки";
// $MESS['USHAKOV_COOKIE_OPT_FONT_SIZE'] = "Размер шрифта текста";
// $MESS['USHAKOV_COOKIE_OPT_FONT_SIZE_PLACEHOLDER'] = "напр. 14px";
